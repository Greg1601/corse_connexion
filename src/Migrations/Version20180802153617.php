 ...
 */
final class Version20180802153617 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE company ADD contact_name LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci');
        ...
        $this->addSql('ALTER TABLE opportunity ADD contact LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci, DROP contact_id');
    }
}
